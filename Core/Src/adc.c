...
void MX_ADC1_Init(void)
{
  ...
  hadc1.Init.ExternalTrigConv = ADC_EXTERNALTRIGCONV_T2_TRGO;          //触发源TIM2
...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  hadc2.Init.DMAContinuousRequests = ENABLE;		//DISABLE
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    hdma_adc1.Init.Mode = DMA_NORMAL;						//DMA_CIRCULAR    DMA_NORMAL			
